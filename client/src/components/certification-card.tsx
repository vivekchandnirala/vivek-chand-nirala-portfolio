...
export function CertificationCard({ 
  ...
  const getCredentialStyle = () => {
    const colors: Record<string, string> = {
      'Coursera': 'bg-blue-100 text-blue-700 border-blue-300 dark:bg-blue-950 dark:text-blue-300 dark:border-blue-800',
      'Infosys': 'bg-green-100 text-green-700 border-green-300 dark:bg-green-950 dark:text-green-300 dark:border-green-800',
